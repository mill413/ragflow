export default {
  translation: {
    ...
    skills: {
      ...
      deleteSelectedTitle: 'Delete selected skill spaces',
      deleteSelectedDescription:
        'Are you sure you want to delete the selected skill spaces? This action cannot be undone.',
      renameSpaceTitle: 'Rename skill space',
      renameSpaceDescription: 'Enter a new name for this skill space.',
      name: 'Name',
      description: 'Description',
      space: 'Skill space',
      sortAsc: 'Ascending',
      sortDesc: 'Descending',
      spaceUpdated: 'Skill space updated successfully',
      versionExists: 'This skill version already exists.',
    },
    skillSearch: {
      ...
      reindexError: 'Failed to rebuild the skill index',
    },
    memories: {
      llmTooltip:
...
Procedural Memory: Learned skills, habits, and automated procedures.`,
      ...
      memoryTypePlaceholder: 'Select memory type',
      descriptionPlaceholder: 'Describe this memory',
      embeddingModel: 'Embedding model',
...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      html4excelTip: `Use with the General chunking method. When disabled, spreadsheets (XLSX, XLSM, or XLS (Excel 97-2003)) in the dataset will be parsed into key-value pairs. When enabled, they will be parsed into HTML tables, splitting every 12 rows if the original table has more than 12 rows. See https://ragflow.io/docs/dev/enable_excel2html for details.`,
...
`,
    ...
    knowledgeConfiguration: {
      ...
      book: `<p>Supported file formats are <b>DOCX, DOCM</b>, <b>PDF</b>, <b>TXT</b>.</p><p>
      For each book in PDF, please set the <i>page ranges</i> to remove unwanted information and reduce analysis time.</p>`,
      laws: `<p>Supported file formats are <b>DOCX, DOCM</b>, <b>PDF</b>, <b>TXT</b>.</p><p>
      ...
      naive: `<p>Supported file formats are <b>MD, MDX, DOCX, DOCM, XLSX, XLSM, XLS (Excel 97-2003), PPTX, PDF, TXT, JPEG, JPG, PNG, TIF, GIF, CSV, JSON, EML, HTML</b>.</p>
      ...
      qa: `
      <p>
      This chunking method supports <b>XLSX, XLSM</b> and <b>CSV/TXT</b> file formats.
    </p>
    <ul>
    <li>
      If a file is in <b>XLSX</b>, <b>XLSM</b>, or <b>XLS (Excel 97-2003)</b> format, it should contain two columns without headers: one for questions and the other for answers, with the question column preceding the answer column. Multiple sheets are
    ...
    <p>
      ...
      `,
      resume: `<p>Supported file formats are <b>DOCX, DOCM</b>, <b>PDF</b>, <b>TXT</b>.
      </p><p>
      Résumés of various forms are parsed and organized into structured data to facilitate candidate search for recruiters.
      </p>
      `,
      table: `<p>Supported file formats are <b>XLSX, XLSM</b> and <b>CSV/TXT</b>.</p><p>
    ...
    If the text extracted by the OCR model is deemed insufficient, a specified visual LLM will be used to provide a description of the image.
      ...
      one: `
    <p>Supported file formats are <b>DOCX, DOCM, XLSX, XLSM, XLS (Excel 97-2003), PDF, TXT</b>.
    </p><p>
    ...
    Applicable when you require the LLM to summarize the entire document, provided it can handle that amount of context length.
      ...
      knowledgeGraph: `<p>Supported file formats are <b>DOCX, DOCM, XLSX, XLSM, XLS, PPT, IMAGE, PDF, TXT, MD, JSON, EML</b>
...
<p>Supported file formats include <b>XLSX, XLSM</b> and <b>CSV/TXT</b>:</p>
<p>If a file is in <b>XLSX or XLSM</b> format, it should contain two columns without headers: one for tag descriptions and the other for tag names, with the Description column preceding the Tag column. Multiple sheets are acceptable, provided the columns are properly structured.</p>
...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
    ...
    setting: {
      ...
      dataSourceSqlQuery: 'SQL query',
      dataSourceSqlQueryPlaceholder: 'Leave empty to load all tables',
      dataSourceContentColumns: 'Content columns',
      dataSourceMetadataColumns: 'Metadata columns',
      dataSourceIdColumn: 'ID column',
      dataSourceTimestampColumn: 'Timestamp column',
      dataSourceMailboxes: 'Mailboxes',
      dataSourcePollRange: 'Poll range',
      dataSourceBucketName: 'Bucket name',
      dataSourceRegion: 'Region',
      dataSourceRegionRequired: 'Region is required when using an access key',
      dataSourcePrefix: 'Prefix',
      dataSourceMode: 'Mode',
      dataSourceS3Compatible: 'S3 compatible',
      dataSourceAuthentication: 'Authentication',
      dataSourceAccessKey: 'Access key',
      dataSourceIamRole: 'IAM role',
      dataSourceAssumeRole: 'Assume role',
      dataSourceAccessKeyId: 'AWS access key ID',
      dataSourceAccessKeyIdRequired: 'AWS access key ID is required',
      dataSourceSecretAccessKey: 'AWS secret access key',
      dataSourceSecretAccessKeyRequired: 'AWS secret access key is required',
      dataSourceRoleArn: 'Role ARN',
      dataSourceRoleArnTip:
        'The role will be assumed by the runtime environment.',
      dataSourceRoleArnRequired: 'Role ARN is required',
      dataSourceNoCredentialsRequired:
        'No credentials required. Uses the default environment role.',
      dataSourceAddressingStyle: 'Addressing style',
      dataSourceVirtualHostedStyle: 'Virtual-hosted style',
      dataSourcePathStyle: 'Path style',
      dataSourceEndpointUrl: 'Endpoint URL',
      dataSourcePruneFrequency: 'Prune frequency',
      dataSourceRefreshFrequency: 'Refresh frequency',
      dataSourceTimeoutSeconds: 'Timeout',
      dataSourceStop: 'Stop',
      dataSourceResume: 'Resume',
      dataSourceSave: 'Save',
      dataSourceTaskType: 'Task type',
      dataSourceSummary: 'Summary',
      dataSourceSync: 'Sync',
      dataSourcePrune: 'Prune',
      dataSourceDurationHours: '{{hours}}h {{minutes}}m {{seconds}}s',
      dataSourceDurationMinutes: '{{minutes}}m {{seconds}}s',
      dataSourceDurationSeconds: '{{seconds}}s',
      dataSourceTaskStartsIn: 'Task starts in {{duration}}',
      dataSourcePruneInProgress: 'Prune in progress',
      dataSourceSyncInProgress: 'Sync in progress',
      dataSourceTaskFailed: 'Task failed',
      dataSourcePruneSummary: 'deleted={{deleted}}, error={{error}}',
      dataSourceSyncSummary:
        'total={{total}}, added={{added}}, updated={{updated}}, error={{error}}',
...
Best for: Documents with flowing, contextually connected content — such as books, manuals, reports, and articles — where narrative coherence depends on keeping adjacent paragraphs together.`,
  ...
  The above is the content you need to summarize.`,
      ...
      includeDownloadInfoInContent: 'Include download information in content',
      browser: 'Browser',
      browserDescription:
...
This process aggregates variables from multiple branches into a single variable to achieve unified configuration for downstream nodes.`,
      ...
      logTimeline: {
        ...
        yahooFinance: 'Querying Yahoo Finance',
        email: 'Sending email',
...
[Insert text here]`,
    ...
    admin: {
      ...
      quotaManagementPage: {
        ...
        state: 'Quota status',
        viewDetail: 'View quota details',
        fileQuotaUsage: 'File-count quota usage',
        storageQuotaUsage: 'File-storage quota usage',
        used: 'Used',
        remaining: 'Remaining',
        exceeded: 'Over limit',
        usageRate: '{{percentage}}% used',
        unlimitedUsage: 'No limit is configured; only actual usage is shown.',
      ...
      monitoringPage: {
        ...
        storagePercentage: '{{percentage}} of storage',
      ...
      resourceManagementPage: {
        ...
        datasetDetail: {
          ...
          parserFields: {
            pages: 'Page range',
            chunk_token_num: 'Chunk token count',
            delimiter: 'Delimiter',
            layout_recognize: 'Layout recognition',
            html4excel: 'Excel to HTML',
            raptor: 'RAPTOR configuration',
            graphrag: 'GraphRAG configuration',
            auto_keywords: 'Auto keywords',
            auto_questions: 'Auto questions',
            table_context_size: 'Table context size',
        ...
        resourceDetail: {
          ...
          fields: {
            ...
            keyword: 'Keyword analysis',
            tts: 'Text to speech',
            toc_enhance: 'Table of contents enhancement',
            parameters: 'Dynamic variables',
            metadata_filter: 'Metadata filter',
            similarity_threshold: 'Similarity threshold',
            vector_similarity_weight: 'Vector similarity weight',
            keyword_similarity_weight: 'Keyword similarity weight',
            use_rerank: 'Enable rerank model',
            rerank_id: 'Rerank model',
            top_n: 'Top N',
            do_refer: 'Show citations',
            highlight: 'Highlight matches',
            summary: 'AI summary',
            related_search: 'Related search',
            query_mindmap: 'Query mind map',
            web_search: 'Web search',
            summary_model: 'Summary model',
            show_chunk_metadata: 'Show chunk metadata',
            ...
            message_history_window_size: 'Message history window',
            kb_ids: 'Datasets',
            tools: 'Tools',
            mcp: 'MCP servers',
            description: 'Description',
      ...
      modelManagementPage: {
        ...
        description:
          'Monitor shared and private models across all workspaces. Administrators can configure shared models and control which personal or team workspaces may use them.',
        addModel: 'Add shared model',
        editModel: 'Edit shared model',
        search: 'Search models, providers, or instances',
        total: 'Models',
        sharedTotal: 'Shared models',
        privateTotal: 'Private models',
        source: 'Source',
