...
Example: Virtual Hosted Style`,
      ...
      mineruApiKeyPlaceholder: 'Optional API key',
    ...
    message: {
      ...
      hint: 'hint',
      resourceInUse: 'Cannot delete: resource is in use',
      resourceReferenceTarget: '{{resource}} is referenced by:',
      ...
      resourceTypes: {
        ...
        dataflowVersion: 'Data flow version',
        dataflowSession: 'Data flow session',
        memory: 'Memory',
        mcp: 'MCP',
        compilationTemplate: 'Compilation template',
        dataSource: 'Data source',
        ...
        workspace: 'Workspace default model',
        file: 'File',
      },
    },
    fileManager: {
...
[Insert text here]`,
    ...
    admin: {
      ...
      teamManagement: {
        ...
        description:
          'Manage all teams, memberships, and team knowledge resource usage.',
        teams: 'Teams',
        team: 'Team',
        newTeam: 'New team',
        editTeam: 'Edit team',
        ...
        deleteTeamDescription:
          'Delete “{{name}}”? Team datasets, chats, agents, searches, and memories must be removed first.',
        ...
        teamId: 'Team ID',
        owner: 'Owner',
        selectOwner: 'Select team owner',
        ownerTransferHint:
          'Changing the owner transfers team ownership and makes the previous owner an administrator. Only active members can be selected.',
        search: 'Search team name, ID, or owner',
        activeMemberships: 'Active memberships',
        teamDatasets: 'Team datasets',
        storage: 'Team file storage',
        members: 'Members',
        member: 'User',
        datasets: 'Datasets',
        documents: 'Files',
        invites: '{{count}} pending',
        pendingInvites: 'Pending invitations',
        noTeams: 'No teams',
        memberManagement: 'Team members',
        addMember: 'Add member',
        selectMember: 'Select user',
        removeMember: 'Remove member',
        removeMemberDescription: 'Remove {{email}} from this team?',
        memberSaved: 'Member saved',
        memberDeleted: 'Member removed',
        noMembers: 'No members',
        role: 'Team role',
        changeRole: 'Change member role',
        changeRoleDescription: 'Change {{email}} to “{{role}}”?',
        roles: {
          owner: 'Owner',
          admin: 'Administrator',
          normal: 'Member',
      ...
      all: 'All',
      actions: 'Actions',
      searchResources: 'Search resource names',
      ...
      noParentDepartment: 'No parent department',
