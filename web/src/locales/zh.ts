...
**重要规则:**
  ...
  - **始终考虑**整个对话历史。`,
    ...
    setting: {
      ...
      dataSourceSqlQuery: 'SQL 查询',
      dataSourceSqlQueryPlaceholder: '留空则加载所有表',
      dataSourceContentColumns: '内容列',
      dataSourceMetadataColumns: '元数据列',
      dataSourceIdColumn: 'ID 列',
      dataSourceTimestampColumn: '时间戳列',
      dataSourceMailboxes: '邮箱文件夹',
      dataSourcePollRange: '轮询范围',
      dataSourceBucketName: '存储桶名称',
      dataSourceRegion: '区域',
      dataSourceRegionRequired: '使用访问密钥时必须填写区域',
      dataSourcePrefix: '路径前缀',
      dataSourceMode: '模式',
      dataSourceS3Compatible: 'S3 兼容存储',
      dataSourceAuthentication: '身份验证',
      dataSourceAccessKey: '访问密钥',
      dataSourceIamRole: 'IAM 角色',
      dataSourceAssumeRole: '代入角色',
      dataSourceAccessKeyId: 'AWS 访问密钥 ID',
      dataSourceAccessKeyIdRequired: '必须填写 AWS 访问密钥 ID',
      dataSourceSecretAccessKey: 'AWS 秘密访问密钥',
      dataSourceSecretAccessKeyRequired: '必须填写 AWS 秘密访问密钥',
      dataSourceRoleArn: '角色 ARN',
      dataSourceRoleArnTip: '运行环境将代入此角色。',
      dataSourceRoleArnRequired: '必须填写角色 ARN',
      dataSourceNoCredentialsRequired: '无需凭证，将使用运行环境的默认角色。',
      dataSourceAddressingStyle: '寻址方式',
      dataSourceVirtualHostedStyle: '虚拟主机样式',
      dataSourcePathStyle: '路径样式',
      dataSourceEndpointUrl: '端点 URL',
      dataSourcePruneFrequency: '清理频率',
      dataSourceRefreshFrequency: '刷新频率',
      dataSourceTimeoutSeconds: '超时时间',
      dataSourceStop: '停止',
      dataSourceResume: '恢复',
      dataSourceSave: '保存',
      dataSourceTaskType: '任务类型',
      dataSourceSummary: '摘要',
      dataSourceSync: '同步',
      dataSourcePrune: '清理',
      dataSourceDurationHours: '{{hours}}时 {{minutes}}分 {{seconds}}秒',
      dataSourceDurationMinutes: '{{minutes}}分 {{seconds}}秒',
      dataSourceDurationSeconds: '{{seconds}}秒',
      dataSourceTaskStartsIn: '任务将在 {{duration}} 后开始',
      dataSourcePruneInProgress: '正在清理',
      dataSourceSyncInProgress: '正在同步',
      dataSourceTaskFailed: '任务失败',
      dataSourcePruneSummary: '已删除={{deleted}}，错误={{error}}',
      dataSourceSyncSummary:
        '总计={{total}}，新增={{added}}，更新={{updated}}，错误={{error}}',
...
示例：虚拟主机样式`,
      ...
      azureDevOpsOrganizationTip:
        '组织名称，或自托管 Azure DevOps Server 的集合地址。',
      azureDevOpsProjectsTip: '以英文逗号分隔的团队项目名称。',
      azureDevOpsRepositoriesTip:
        '以英文逗号分隔的仓库；可使用 project/repository 区分同名仓库。',
      azureDevOpsOrganizationScopeTip:
        '将索引该组织中令牌可见的所有仓库。',
      azureDevOpsContentTypesTip: '选择源文件、拉取请求，或两者。',
      dataSourceFieldAzureDevOpsPat: '个人访问令牌',
      dataSourceFieldAzureDevOpsOrganization: '组织',
      dataSourceFieldIndexMode: '索引范围',
      ...
      dataSourceValidationFieldRequired: '请输入{{label}}',
      githubDescription:
      ...
      changePassword: '修改密码',
      createPassword: '创建密码',
      createPasswordHint: '当前账号尚未设置密码，请创建密码以启用密码登录。',
      noPassword: '尚未设置密码',
...
[在此处插入文本]`,
    ...
    admin: {
      ...
      apiDocsPage: {
        title: 'API 文档',
        description:
          '查看管理后台与主站资源接口，并使用当前管理员身份直接发送调试请求。',
        adminTab: '管理后台 API',
        mainTab: '主站 API',
        mainTitle: '主站资源 API',
        mainDescription:
          '当前收录团队、知识库、聊天和搜索相关接口，后续将继续补充其他主站资源。',
        loadFailed: '管理 API 文档加载失败',
        mainLoadFailed: '主站 API 文档加载失败',
        groups: {
          team: '团队',
          dataset: '知识库',
          chat: '聊天',
      ...
      apiTokenManagementPage: {
        title: 'API Token 管理',
        description:
          '统一管理个人与团队工作空间的 API Token。管理员可以在列表中查看和复制完整 Token。',
        create: '新建 Token',
        delete: '删除 Token',
        token: 'Token',
        workspace: '所属工作空间',
        workspacePlaceholder: '选择个人或团队工作空间',
        workspaceType: '工作空间类型',
        source: '使用范围',
        createdAt: '创建时间',
        updatedAt: '最后修改时间',
        search: '搜索 Token、工作空间或 ID',
        total: 'Token 总数',
        personalTotal: '个人空间 Token',
        teamTotal: '团队空间 Token',
        resourceTotal: '应用绑定 Token',
        createDescription:
          'Token 创建后即绑定到所选工作空间，后续不能移动到其他工作空间。',
        deleteDescription:
          '确定删除这个 Token 吗？使用该 Token 的所有 API 调用将立即失效。',
        created: 'API Token 已创建',
        deleted: 'API Token 已删除',
        secretTitle: '保存 API Token',
        secretDescription:
          'Token 已创建。你可以立即复制，也可以稍后在管理列表中查看。',
        savedSecret: '我已保存',
        workspaceTypes: {
          personal: '个人',
          team: '团队',
      ...
      resourceManagementPage: {
        ...
        viewFullFailureReason: '点击该行或“查看详情”打开完整日志',
        viewFailureDetail: '查看解析失败详情',
        importantFailureMessages: '关键错误信息',
        fullParseLog: '完整解析日志',
        noFailureReason:
          '未记录解析日志，请使用文件 ID 查看解析 Worker 的运行日志。',
        parseStartedAt: '开始解析时间',
        parseDuration: '解析耗时',
        sessions: '会话数',
      ...
      userImportDescription:
        '支持 CSV 和 Excel 文件。每行创建一个普通用户，已有邮箱不会被覆盖。',
      userImportColumns:
        '必填列：email、password；可选列：nickname、department。部门使用“上级/下级”格式，缺少的层级会自动创建。',
      userImportEmptyFile: '文件中没有可导入的用户数据',
      userImportReadFailed: '无法读取导入文件',
      userImportSucceeded: '用户导入完成',
      userImportSummary:
        '共 {{total}} 条，成功 {{created}} 条，失败 {{failed}} 条',
      userImportRowError: '第 {{row}} 行（{{email}}）：{{message}}',
      changePassword: '修改密码',
      newPassword: '新密码',
